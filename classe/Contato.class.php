<?php
    ...
    class Contato{
        ...
        public function buscarDados(){
            ...
            $res = array();
            $cmd = $this->pdo->query(" SELECT `idContato`,`nome` ,`empresa`,`identificacao`,`apartamento`,`bloco`,DATE_FORMAT(`data_cadastro`, '%d%/%m/%Y - %h:%i:%s') as data_formatada FROM contato ORDER BY idContato");
